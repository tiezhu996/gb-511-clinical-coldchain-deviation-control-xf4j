...
func handleError(c *gin.Context, err error) {
	...
	case errors.Is(err, service.ErrInvalidTransition), errors.Is(err, service.ErrInvalidInput), errors.Is(err, service.ErrStaleAssessment),
		errors.Is(err, repository.ErrInvalidWorkflowState), errors.Is(err, repository.ErrStaleAssessment):
