...
type DispositionDecisionHandler struct {
	service service.DispositionDecisionService
}

func NewDispositionDecisionHandler(s service.DispositionDecisionService) *DispositionDecisionHandler {
	return &DispositionDecisionHandler{service: s}
}

func (h *DispositionDecisionHandler) Register(group *gin.RouterGroup) {
...
func (h *DispositionDecisionHandler) list(c *gin.Context) {
	query := bindPage(c)
...
func (h *DispositionDecisionHandler) get(c *gin.Context) {
	id, ok := parseID(c)
	if !ok {
		return
	}
...
func (h *DispositionDecisionHandler) create(c *gin.Context) {
	var input dto.CreateDispositionDecision
...
func (h *DispositionDecisionHandler) update(c *gin.Context) {
	id, ok := parseID(c)
	if !ok {
		return
	}
	var input dto.UpdateDispositionDecision
	if err := c.ShouldBindJSON(&input); err != nil {
		util.Fail(c, http.StatusBadRequest, "invalid_request", err.Error())
		return
	}
...
func (h *DispositionDecisionHandler) transition(c *gin.Context) {
	id, ok := parseID(c)
	if !ok {
		return
	}
...
func (h *DispositionDecisionHandler) remove(c *gin.Context) {
	id, ok := parseID(c)
	if !ok {
		return
	}
